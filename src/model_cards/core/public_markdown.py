"""Deterministic Markdown rendering for the published Model Card.
...
from .public import assert_public_projection, validate_public_card
from .schema import (
    NOT_APPLICABLE,
    NOT_SPECIFIED,
    PUBLIC_FIELD_PATHS as FIELD_PATHS,
    PUBLIC_SECTIONS as SECTION_FIELDS,
)
