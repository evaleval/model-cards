...
| --- | --- | --- |
| [Lack of data transparency](<https://www.ibm.com/docs/en/watsonx/saas?topic=SSYOK8/wsj/ai-risk-atlas/lack-of-data-transparency.html>) | Card names only &\#x27;alpaca\_data\_sampled\_ifd\_new\_5200&\#x27; and gives no dataset composition, collection, or curation details, so training\-data transparency is lacking\. | Lack of data transparency might be due to insufficient documentation of training or tuning dataset details, including synthetic data generation\.  |
