...
| --- | --- | --- |
| [Lack of model transparency](<https://www.ibm.com/docs/en/watsonx/saas?topic=SSYOK8/wsj/ai-risk-atlas/lack-of-model-transparency.html>) | Card gives only high\-level training data description \(&\#x27;text dataset drawn from a wide variety of sources&\#x27;\) and no evaluation details, so design/development/evaluation process is insufficiently documented\. | Lack of model transparency is due to insufficient documentation of the model design, development, and evaluation process and the absence of insights into the inner workings of the model\. |
| [Lack of data transparency](<https://www.ibm.com/docs/en/watsonx/saas?topic=SSYOK8/wsj/ai-risk-atlas/lack-of-data-transparency.html>) | Card states training data only as &\#x27;text dataset drawn from a wide variety of sources&\#x27; without dataset details, so training/tuning dataset documentation is insufficient\. | Lack of data transparency might be due to insufficient documentation of training or tuning dataset details, including synthetic data generation\.  |
| [Inaccessible training data](<https://www.ibm.com/docs/en/watsonx/saas?topic=SSYOK8/wsj/ai-risk-atlas/inaccessible-training-data.html>) | No training data access is provided in the card; only a vague &\#x27;wide variety of sources&\#x27; description is given\. | Without access to the training data, the types of explanations a model can provide are limited and more likely to be incorrect\. |
