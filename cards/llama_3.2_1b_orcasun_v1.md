...
| [Prompt leaking](<https://www.ibm.com/docs/en/watsonx/saas?topic=SSYOK8/wsj/ai-risk-atlas/prompt-leaking.html>) | open\-weight instruct/chat model; system prompts may be extractable, and no prompt\-leak evaluation is reported | &\#x27;A prompt leak attack attempts to extract a model&\#x27;s system prompt \(also known as the system message\)\.&\#x27; |
