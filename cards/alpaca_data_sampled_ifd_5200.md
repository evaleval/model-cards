...
| --- | --- | --- |
| [Lack of data transparency](<https://www.ibm.com/docs/en/watsonx/saas?topic=SSYOK8/wsj/ai-risk-atlas/lack-of-data-transparency.html>) | The card names only &\#x27;alpaca\_data\_sampled\_ifd\_5200&\#x27; as training data and gives no dataset documentation, so training\-data details are not transparent\. | Lack of data transparency might be due to insufficient documentation of training or tuning dataset details, including synthetic data generation\.  |
