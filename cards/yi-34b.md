...
Paired JSON: [yi\-34b\.json](<./yi-34b.json>)<br>
SHA-256: `efc5bccb9ba262183088e64c3d49a30c63924ff2143623622b4cfdf6e776e25c`
...
| Version | e1fa7c83283f2e1d5a12cb4adea37c3f829e28f8 |
...
| Model size | 64\.1 GiB of safetensors weights \(68,777,897,896 bytes\) in BF16 |
...
| Downloads | 10,318 downloads \(Hub 30\-day window, as of 2026\-09\-07\) |
| Likes | 1,301 likes on the Hub \(as of 2026\-09\-07\) |
...
| Field | Value |
| --- | --- |
| Model card | [https://huggingface\.co/01\-ai/Yi\-34B](<https://huggingface.co/01-ai/Yi-34B>) |
...
| --- | --- | --- |
| [Impact on the environment](<https://www.ibm.com/docs/en/watsonx/saas?topic=SSYOK8/wsj/ai-risk-atlas/impact-on-the-environment.html>) | open\-weight 34B dense decoder\-only model trained from scratch \-&gt; substantial compute and energy use for training | AI, and large generative models in particular, might produce increased carbon emissions and increase water usage for their training and operation\. |
