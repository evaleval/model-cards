...
| Human evaluations | The developer constructed an internal annotated code preference benchmark called Code Arena, similar to Arena Hard, to evaluate alignment with human preferences, and reports that the results demonstrate the model's advantages in preference alignment\. |
